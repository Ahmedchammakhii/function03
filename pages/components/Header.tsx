...
export default function Header() {
    return (
        ...
        <p >We are Web3 data enthusiasts. <span><img src='https://cryptologos.cc/logos/ethereum-eth-logo.png' style={{objectFit:"contain",width:"20px",height:"20px",position:"absolute"}}/></span></p>
        </div>
          </div>  
